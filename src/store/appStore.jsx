...
const initialState = {
  ...
  workspaceData: {
    [DEFAULT_WORKSPACE_ID]: {
      ...
      webhooks: { instagram: '', linkedin: '', instagramSchedule: '', instagramScheduleRegen: '', linkedinSchedule: '', linkedinScheduleRegen: '', instagramReels: '', campaignPlanner: '', instagramPlanGen: '', linkedinPlanGen: '', elongateIdea: '', captionStudio: '', draftCopy: '', mediaOptions: '', videoRender: '', publishPost: '', zernioSync: '', zernioDashboard: '', creativeGenerate: '', creativeEdit: '', creativeVideo: '', creativeCompose: '', creativeEnhance: '', creativeVideoEdit: '', creativeStitch: '' },
