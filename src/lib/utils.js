...
export const STATUS_META = {
  ...
  scheduled:       { label:'Scheduled', classes:'bg-sky-50 text-sky-700' },
  publishing:      { label:'Publishing', classes:'bg-sky-50 text-sky-700' },
  published:       { label:'Published', classes:'bg-sage-100 text-sage-700' },
  ...
  pending_publish: { label:'Pending',   classes:'bg-amber-100 text-amber-700' },
  pending_review:  { label:'Pending review', classes:'bg-clay-50 text-clay-700' },
