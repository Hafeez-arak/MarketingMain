...
const WORKFLOW_CONFIGS = [
  ...
  },
  {
    ...
    description: 'Publishes or schedules an approved post on every connected platform through Zernio. The API key lives in n8n, never in this app. Moving or cancelling a scheduled post goes through here too.',
    icon: (
      <div className="w-8 h-8 flex items-center justify-center flex-shrink-0" style={{ background: '#8b5cf6' }}>
        <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" strokeWidth="1.75" viewBox="0 0 24 24">
